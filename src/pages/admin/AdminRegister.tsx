...
const AdminRegister = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const success = await register("admin", {
      ...
      <div className="relative overflow-hidden">
        ...
        >
          ...
          <motion.div 
            ...
            className="absolute -bottom-40 -left-40 h-80 w-80 rounded-full admin-gradient opacity-10 blur-3xl" 
          />
        </motion.div>
          ...
          >
            <Card className="rounded-3xl bg-card shadow-card border border-border">
              <CardHeader className="space-y-4 text-center pb-8">
                ...
                <div>
                  <CardTitle className="text-2xl font-bold font-display text-foreground">Admin Registration</CardTitle>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <Button
                type="submit"
                disabled={isLoading}
                className="w-full h-11 admin-gradient border-0 text-primary-foreground font-semibold shadow-lg rounded-xl"
              >
                {isLoading ? (
                  <>
            ...
            <div className="mt-6 text-center space-y-3">
              <p className="text-sm text-muted-foreground">
                ...
                <Button
                  ...
                  className="p-0 h-auto admin-gradient-text bg-clip-text text-transparent hover:opacity-80 font-semibold"
                >
                  Sign in here
                </Button>
              </p>
